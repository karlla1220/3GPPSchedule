...
def _generate_js(timezone: str = "UTC", auto_refresh_minutes: int = AUTO_REFRESH_MINUTES, state_id: str = "schedule") -> str:
...
<script>{_generate_js(schedule.timezone, state_id=schedule.wg_id + ":" + schedule.meeting_id)}</script>
</body>
</html>""")
